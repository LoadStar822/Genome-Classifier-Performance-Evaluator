        ...
        if file_prefix.endswith('1.fq'):
            ...
            for classifier in classifiers:
                ...
                if classifier == 'kraken2':
                    ...
                    command = f'diamond blastp -d {databases[classifier]} -q {protein_fastq} -o {output_file} --threads {num_threads} --outfmt 6 qseqid staxids'
                    ...
                    protein = os.path.join(protein_folder, f'{file_base}_proteinDB')
                    command = f'mmseqs taxonomy {protein} {databases[classifier]} {output_file} tmp/{file_base}'
